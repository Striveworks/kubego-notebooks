...
CdkCombobox.ɵfac = function CdkCombobox_Factory(t) { return new (t || CdkCombobox)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc1.Overlay), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.Directionality, 8)); };
CdkCombobox.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: CdkCombobox, selectors: [["", "cdkCombobox", ""]], hostAttrs: ["role", "combobox", 1, "cdk-combobox"], hostVars: 5, hostBindings: function CdkCombobox_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("click", function CdkCombobox_click_HostBindingHandler() { return ctx._handleInteractions("click"); })("focus", function CdkCombobox_focus_HostBindingHandler() { return ctx._handleInteractions("focus"); })("keydown", function CdkCombobox_keydown_HostBindingHandler($event) { return ctx._keydown($event); })("click", function CdkCombobox_click_HostBindingHandler($event) { return ctx._attemptClose($event); }, false, ɵngcc0.ɵɵresolveDocument);
    } if (rf & 2) {
        ɵngcc0.ɵɵattribute("aria-disabled", ctx.disabled)("aria-owns", ctx.contentId)("aria-haspopup", ctx.contentType)("aria-expanded", ctx.isOpen())("tabindex", ctx._getTabIndex());
    } }, inputs: { panel: ["cdkComboboxTriggerFor", "panel"], disabled: "disabled", openActions: "openActions", autoSetText: "autoSetText", value: "value" }, outputs: { opened: "comboboxPanelOpened", closed: "comboboxPanelClosed", panelValueChanged: "panelValueChanged" }, exportAs: ["cdkCombobox"] });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CdkCombobox, [{
        type: Directive,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc1.Overlay }, { type: ɵngcc0.ViewContainerRef }, { type: ɵngcc2.Directionality, decorators: [{
                type: Optional
            }] }]; }, { opened: [{
            type: Output,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CdkComboboxPopup, [{
    ...
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: CdkComboboxPanel, decorators: [{
                type: Optional
            }, {
                type: Inject,
                args: [PANEL]
...
CdkComboboxModule.ɵfac = function CdkComboboxModule_Factory(t) { return new (t || CdkComboboxModule)(); };
CdkComboboxModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: CdkComboboxModule });
CdkComboboxModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[OverlayModule]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CdkComboboxModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(CdkComboboxModule, { declarations: function () { return [CdkCombobox, CdkComboboxPanel, CdkComboboxPopup]; }, imports: function () { return [OverlayModule]; }, exports: function () { return [CdkCombobox, CdkComboboxPanel, CdkComboboxPopup]; } }); })();
