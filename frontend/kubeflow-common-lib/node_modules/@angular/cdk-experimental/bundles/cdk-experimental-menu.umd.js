(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/cdk/overlay'),require('@angular/cdk/bidi'),require('@angular/cdk/collections'),exports, require('@angular/core'), require('@angular/cdk/overlay'), require('@angular/cdk/a11y'), require('@angular/cdk/keycodes'), require('@angular/cdk/bidi'), require('rxjs'), require('rxjs/operators'), require('@angular/cdk/collections'), require('@angular/cdk/coercion'), require('@angular/cdk/portal')) :
    typeof define === 'function' && define.amd ? define('@angular/cdk-experimental/menu', ['@angular/core','@angular/cdk/overlay','@angular/cdk/bidi','@angular/cdk/collections','exports', '@angular/core', '@angular/cdk/overlay', '@angular/cdk/a11y', '@angular/cdk/keycodes', '@angular/cdk/bidi', 'rxjs', 'rxjs/operators', '@angular/cdk/collections', '@angular/cdk/coercion', '@angular/cdk/portal'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ng.core,global.ng.cdk.overlay,global.ng.cdk.bidi,global.ng.cdk.collections,(global.ng = global.ng || {}, global.ng.cdkExperimental = global.ng.cdkExperimental || {}, global.ng.cdkExperimental.menu = {}), global.ng.core, global.ng.cdk.overlay, global.ng.cdk.a11y, global.ng.cdk.keycodes, global.ng.cdk.bidi, global.rxjs, global.rxjs.operators, global.ng.cdk.collections, global.ng.cdk.coercion, global.ng.cdk.portal));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,ɵngcc3,exports, i0, overlay, a11y, keycodes, bidi, rxjs, operators, collections, coercion, portal) { 'use strict';
...
TargetMenuAim.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: TargetMenuAim, factory: function (t) { return TargetMenuAim.ɵfac(t); } });
...
CdkMenuItemSelectable.ɵfac = /*@__PURE__*/ function () { var ɵCdkMenuItemSelectable_BaseFactory; return function CdkMenuItemSelectable_Factory(t) { return (ɵCdkMenuItemSelectable_BaseFactory || (ɵCdkMenuItemSelectable_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(CdkMenuItemSelectable)))(t || CdkMenuItemSelectable); }; }();
CdkMenuItemSelectable.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: CdkMenuItemSelectable, inputs: { checked: "checked", name: "name", id: "id" }, outputs: { toggled: "cdkMenuItemToggled" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
...
CdkMenuGroup.ɵfac = function CdkMenuGroup_Factory(t) { return new (t || CdkMenuGroup)(); };
CdkMenuGroup.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: CdkMenuGroup, selectors: [["", "cdkMenuGroup", ""]], contentQueries: function CdkMenuGroup_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, CdkMenuItemSelectable, 5);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx._selectableItems = _t);
    } }, hostAttrs: ["role", "group", 1, "cdk-menu-group"], outputs: { change: "change" }, exportAs: ["cdkMenuGroup"], features: [ɵngcc0.ɵɵProvidersFeature([{ provide: collections.UniqueSelectionDispatcher, useClass: collections.UniqueSelectionDispatcher }])] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CdkMenuGroup, [{
        type: i0.Directive,
        args: [{
...
CdkMenu.ɵfac = function CdkMenu_Factory(t) { return new (t || CdkMenu)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(MENU_AIM, 10), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.Directionality, 8), ɵngcc0.ɵɵdirectiveInject(CdkMenuPanel, 8)); };
...
CdkMenuBar.ɵfac = function CdkMenuBar_Factory(t) { return new (t || CdkMenuBar)(ɵngcc0.ɵɵdirectiveInject(MenuStack), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(MENU_AIM, 10), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.Directionality, 8)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CdkMenuBar, [{
    ...
    }], function () { return [{ type: MenuStack }, { type: ɵngcc0.NgZone }, { type: ɵngcc0.ElementRef }, { type: undefined, decorators: [{
                type: i0.Self
            }, {
                type: i0.Optional
            }, {
...
CdkMenuItemRadio.ɵfac = function CdkMenuItemRadio_Factory(t) { return new (t || CdkMenuItemRadio)(ɵngcc0.ɵɵdirectiveInject(ɵngcc3.UniqueSelectionDispatcher), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.NgZone), ɵngcc0.ɵɵdirectiveInject(CDK_MENU, 8), ɵngcc0.ɵɵdirectiveInject(MENU_AIM, 8), ɵngcc0.ɵɵdirectiveInject(ɵngcc2.Directionality, 8), ɵngcc0.ɵɵdirectiveInject(CdkMenuItemTrigger, 10)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CdkMenuItemRadio, [{
    ...
    }], function () { return [{ type: ɵngcc3.UniqueSelectionDispatcher }, { type: ɵngcc0.ElementRef }, { type: ɵngcc0.NgZone }, { type: undefined, decorators: [{
                type: i0.Optional
            }, {
                type: i0.Inject,
                args: [CDK_MENU]
...
CdkMenuItemCheckbox.ɵfac = /*@__PURE__*/ function () { var ɵCdkMenuItemCheckbox_BaseFactory; return function CdkMenuItemCheckbox_Factory(t) { return (ɵCdkMenuItemCheckbox_BaseFactory || (ɵCdkMenuItemCheckbox_BaseFactory = ɵngcc0.ɵɵgetInheritedFactory(CdkMenuItemCheckbox)))(t || CdkMenuItemCheckbox); }; }();
...
CdkMenuModule.ɵfac = function CdkMenuModule_Factory(t) { return new (t || CdkMenuModule)(); };
CdkMenuModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: CdkMenuModule });
CdkMenuModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[overlay.OverlayModule]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(CdkMenuModule, [{
        type: i0.NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(CdkMenuModule, { declarations: [CdkMenuBar, CdkMenu, CdkMenuPanel, CdkMenuItem, CdkMenuItemRadio, CdkMenuItemCheckbox, CdkMenuItemTrigger, CdkMenuGroup, CdkContextMenuTrigger, CdkTargetMenuAim], imports: [ɵngcc1.OverlayModule], exports: [CdkMenuBar, CdkMenu, CdkMenuPanel, CdkMenuItem, CdkMenuItemRadio, CdkMenuItemCheckbox, CdkMenuItemTrigger, CdkMenuGroup, CdkContextMenuTrigger, CdkTargetMenuAim] }); })();
