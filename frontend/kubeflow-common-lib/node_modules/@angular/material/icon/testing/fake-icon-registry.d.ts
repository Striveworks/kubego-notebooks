...
export declare class FakeMatIconRegistry implements PublicApi<MatIconRegistry>, OnDestroy {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<FakeMatIconRegistry, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<FakeMatIconRegistry>;
}
/** Import this module in tests to install the null icon registry. */
export declare class MatIconTestingModule {
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<MatIconTestingModule, never>;
    static ɵmod: ɵngcc0.ɵɵNgModuleDeclaration<MatIconTestingModule, never, never, never>;
    static ɵinj: ɵngcc0.ɵɵInjectorDeclaration<MatIconTestingModule>;
}
export {};
